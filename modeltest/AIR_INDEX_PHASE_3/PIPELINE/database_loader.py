            ...
            with conn.cursor() as cur:
                ...
                for o in valid_rows:
                    cur.execute(
                        ...
                        outlier_flag,collected_timestamp,collection_run_id,source_url,collector_name,currency,data_mode,
                        ...
                        (
                            ...
                            o.get("currency","INR"),o.get("data_mode","FIXTURE"),o.get("flight_number"),o.get("departure_time"),o.get("arrival_time"),
